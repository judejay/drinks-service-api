...
export const getTea = async (req: Request<object, object, object, { teaName: string | undefined }>, res:
Response) => {
const teaName  = req.query.teaName;
const tea = teaService.getTea(teaName as
string);
res.json(tea).status(200);
};

export const getTeaLover = async (req: Request, res: Response) =>{
    res.json("I like tea!").status(200)
}